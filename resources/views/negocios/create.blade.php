    ...
    <div class="col-md-12">
      <form action="{{ route('negocios.store') }}" method="POST"  class="form-horizontal">
        ...
        <div class="form-group @if($errors->has('rif')) has-error @endif">
          ...
          <div class="col-sm-4">
            <input type="text" id="rif-field" name="rif" class="form-control" value="{{ old("rif") }}"/>
            @if($errors->has("rif"))
        ...
        <div class="form-group @if($errors->has('encargado')) has-error @endif">
          ...
          <div class="col-sm-4">
            <input type="text" id="encargado-field" name="encargado" class="form-control" value="{{ old("encargado") }}"/>
        ...
        <div class="form-group @if($errors->has('telefono')) has-error @endif">
          <label for="telefono-field" class="col-sm-2 control-label">Telefono</label>
          <div class="col-sm-4">
            <input type="text" id="telefono-field" name="telefono" class="form-control" value="{{ old("telefono") }}"/>
        ...
        <div class="form-group @if($errors->has('direccion')) has-error @endif">
          <label for="direccion-field" class="col-sm-2 control-label">Dirección</label>
          <div class="col-sm-4">
            <input type="text" id="nombre-field" name="direccion" class="form-control" value="{{ old("direccion") }}"/>
