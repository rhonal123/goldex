...
@section('content')
  ...
  <div class="row" style="margin-bottom: 5px;">
    <div class="col-md-6">
      ...
      <a class="btn btn-primary btn-sm" href="{{ route('cuentas.gastos',[$cuenta->id, 'desde' => $desde, 'hasta' => $hasta ]) }}">
        Gastos
      </a>
    </div>
    ...
    @if($gastos->count())
      <div class="table-responsive">
        <table class="table table-condensed">
          ...
          <tbody>
            @each('cuentas.gasto', $gastos, 'gasto')
          </tbody>
        </table>
        ...
        <div class="col-md-8" align="right">
          <div class="paginador">
            {{ $gastos->appends(Request::only('desde','hasta'))->links() }}
          </div>
        </div>
      @else
