      ...
      <form action="{{ route('gastos.update', $gasto->id) }}" method="POST" class="form-horizontal">
        ...
        <div class="form-group @if($errors->has('monto')) has-error @endif">
          ...
          <div class="col-sm-2">
            ...
            value="{{ is_null(old("monto")) ? $gasto->monto : old("monto") }}"
            step="any"
            />
            @if($errors->has("monto"))
        ...
        <div id="form-referencia" class="form-group @if($errors->has('referencia')) has-error @endif">
          ...
          <div class="col-sm-4">
            <input type="text" id="referencia-field" name="referencia" class="form-control"
               value="{{ is_null(old("referencia")) ? $gasto->referencia : old("referencia") }}"/>
        ...
        <div class="form-group @if($errors->has('fecha')) has-error @endif">
          ...
          <div class="col-sm-4">
                <div class='input-group date' id='fecha'>
                    <input type="text" id="fecha-field" name="fecha" class="form-control" value="{{ is_null(old("fecha")) ? $gasto->fecha : old("fecha") }}" />
        ...
        <div class="form-group @if($errors->has('descripcion')) has-error @endif">
          ...
          <div class="col-sm-4">
            <textarea  id="descripcion-field" name="descripcion" class="form-control" >{{ is_null(old("descripcion")) ? $gasto->descripcion : old("descripcion") }}</textarea>
